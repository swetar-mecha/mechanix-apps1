...
impl SimpleComponent for AboutPage {
    ...
    fn init(
        ...
        about_details_row_3.append(&version_label);
        about_details_row_3.append(&version_value);
        ...
        about_details_row_4.append(&serial_no_label);
        about_details_row_4.append(&serial_no_value);
        ...
        about_details_row_5.append(&wifi_address_label);
        about_details_row_5.append(&wifi_address_value);
        about_details_list2.append(&about_details_row_5);


        let about_details_row6 = gtk::Box::builder()
        .orientation(gtk::Orientation::Horizontal)
        .hexpand(true)
        .css_classes(["network-details-box-row"])
        .build();
        ...
        about_details_row6.append(&ethernet_address_label);
        about_details_row6.append(&ethernet_address_value);
        about_details_list2.append(&about_details_row6);
